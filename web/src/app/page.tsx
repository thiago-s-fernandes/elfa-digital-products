    ...
    <Container as="main">
      <div className={cn("flex flex-col gap-8 w-full items-center")}>
        <div className={cn("flex flex-col gap-2")}>
          ...
          <p className={cn("text-center text-muted-foreground text-sm", "lg:text-lg")}>
            Gerencie seu inventário com facilidade através de nosso sistema.
          </p>
        </div>
        <div className={cn("w-full flex flex-col gap-4 max-w-4xl", "md:flex-row")}>
          <QuickAccessCard
            configs={{
              icon: <Package size={28} className={cn("w-6 h-6", "lg:w-7 lg:h-7")} />,
          ...
          <QuickAccessCard
            configs={{
              icon: <CirclePlus size={28} className={cn("w-6 h-6", "lg:w-7 lg:h-7")} />,
              title: "Novo Produto",
              description:
