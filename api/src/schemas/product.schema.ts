...
export const productFindOneParamsSchema = z
  ...
  .strict();
export type ProductFindOneParamsSchema = z.infer<typeof productFindOneParamsSchema>;
...
export const productFindOneInputSchema = z
  ...
  .strict();
export type ProductFindOneInputSchema = z.infer<typeof productFindOneInputSchema>;
...
export const productFindAllQuerySchema = z
  ...
  .strict();
export type ProductFindAllQuerySchema = z.infer<typeof productFindAllQuerySchema>;
...
export const productFindAllInputSchema = z
  ...
  .strict();
export type ProductFindAllInputSchema = z.infer<typeof productFindAllInputSchema>;
...
export const productCreateSuccessResponseSchema = z
  ...
  .strict();
export type ProductCreateSuccessResponseSchema = z.infer<typeof productCreateSuccessResponseSchema>;

// Errors
export const productErrBadRequestErrorResponseSchema = errBadRequestErrorResponseSchema;
export const productErrForbiddenErrorResponseSchema = errForbiddenErrorResponseSchema;
export const productErrInternalServerErrorResponseSchema = errInternalServerErrorResponseSchema;
export const productErrNotFoundErrorResponseSchema = z.object({
  error: z
    .union([z.literal(ErrorCode.NOT_FOUND_ERROR), z.literal(ProductResponseCode.BRAND_NOT_FOUND)])
